...
class _LoginState extends State<Login> {
  final signcontrller = Get.isRegistered<Signincontrollerimp>()
      ? Get.find<Signincontrollerimp>()
  ...
  @override
  void initState() {
    disableScreenshots(); // Disable screenshots for the login screen
    super.initState();
  }
